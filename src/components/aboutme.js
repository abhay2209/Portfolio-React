...
class About extends Component {
    render() {
        return(
            ...
            <p>I was also a <b>Teaching Assistant</b> in Fall 2021 for a upper credit Computing Science course CMPT 363 (UI/UX Design) and have done the same before in Spring 2021. I held regular office hours to solve student doubts, moderate lectures with the professor and grade the course assignments.</p> 
