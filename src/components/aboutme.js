...
class About extends Component {
    render() {
        return(
            ...
            <p>I was also a <b>Teaching Assistant</b> in Fall 2021 for an upper credit Computing Science course CMPT 363 (UI/UX Design) and have done the same before in Spring 2021. I held regular office hours to solve student doubts, moderate lectures with the professor and grade the course assignments.</p> 
            ...
            <p>With these vast spectrum of experiences, not only I have learned a lot about technology but also have developed many <b>interpersonal skills</b>. I have worked in different teams at work as well as school where I learned teamwork. As a TA, I learned more about leadership, taking responsibility and be a self starter. This also helped me increase my attention to detail and critical thinking capabilities.</p></div>
            </div>
        )
    }
}
